        ...
        if(data.result.length > 0)
        {
          ...
          for(idx in data.result){
            ...
            $('#eatery-list').append('<li class="act-eatery"><input type=hidden id="eateryId" value="' + data.result[idx].id 
              + '" /> <div class="behind"> <a href="#" class="ui-btn delete-btn"><i class="fa fa-trash-o" aria-hidden="true" style="font-size:30px; color:#00B2A9; margin:0 5px 0 5px">&nbsp</i><br>Delete</a> <a href="#" class="ui-btn edit-btn pull-left"><i class="fa fa-heart-o" aria-hidden="true" style="font-size:30px; color:#00B2A9; margin:0 5px 0 5px">&nbsp</i><br>Favourite</a></div><a href="" data-id="' + data.result[idx].id 

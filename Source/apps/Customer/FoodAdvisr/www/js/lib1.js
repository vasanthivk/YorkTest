...
profileTools.set=function(profileId){
	appdata.userProfiles[appdata.state.profileNo]=profileId;
...
picker.startIntol=function(title,intolerance){
	...
	op+='<h5 class="act-settings-section" data-intolerance="'+intolerance+'">'+title+'<span class="icon icon-down"></span></h5>';

        ...
        <div class="login-container">        
            <div class="login-box animated fadeInDown">
                ...
                <div class="login-body">
                    <div class="login-title" style="text-align: center;"><strong>Log In</strong> to your account</div>
                    <div class="col-md-12">
@if ($errors->all())
...
@endif
                    ...
                    <form action="{{URL::to('validateuser')}}" class="form-horizontal" method="post">

                                            ...
                                            <div >
                                                ...
                                                <div style="float:left;padding-right:10px;">
                                                 <?php  $status = $user->status; 
                                                    ...
                                                    {
                                                 ?> 
                                                    <a href="../../userpermissions?userid={{$user->id}}"> 
                                                    <button type="submit" class="btn btn-success btn-xs pull-right" style="font-size: 11px;padding: 4px 12px;">User Permissons
                                                    </button></a>
                                                   <?php } ?> 
                                                </div>
